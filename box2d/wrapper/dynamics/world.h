...
EXPORT void World_step(b2World* self, float timeStep, int32_t velocityIterations, int32_t positionIterations);
EXPORT void World_clear_forces(b2World* self);
EXPORT void World_debug_draw(b2World* self);
EXPORT void World_query_aabb(const b2World* self, b2QueryCallback* callback, const b2AABB* aabb);
EXPORT void World_ray_cast(const b2World* self, b2RayCastCallback* callback, const b2Vec2* p1, const b2Vec2* p2);
...
EXPORT b2ContactManager World_get_contact_manager(const b2World* self);
EXPORT b2Profile World_get_profile(const b2World* self);
