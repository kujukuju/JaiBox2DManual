...
EXPORT const b2Body* World_get_body_list_const(const b2World* self);
EXPORT b2Joint* World_get_joint_list(b2World* self);
EXPORT const b2Joint* World_get_joint_list_const(const b2World* self);
EXPORT b2Contact* World_get_contact_list(b2World* self);
EXPORT const b2Contact* World_get_contact_list_const(const b2World* self);
...
EXPORT i32 World_get_proxy_count(const b2World* self);
EXPORT i32 World_get_body_count(const b2World* self);
EXPORT i32 World_get_joint_count(const b2World* self);
EXPORT i32 World_get_contact_count(const b2World* self);
EXPORT i32 World_get_tree_height(const b2World* self);
EXPORT i32 World_get_tree_balance(const b2World* self);
EXPORT f32 World_get_tree_quality(const b2World* self);
