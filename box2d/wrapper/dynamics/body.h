...
EXPORT void Body_apply_angular_impulse(b2Body* self,
                                f32 impulse,
                                bool wake);
EXPORT f32 Body_get_mass(const b2Body* self);
EXPORT f32 Body_get_inertia(const b2Body* self);
...
EXPORT b2Vec2 Body_get_linear_velocity_from_local_point(const b2Body* self,
                                                 const b2Vec2* point);
EXPORT f32 Body_get_linear_damping(const b2Body* self);
EXPORT void Body_set_linear_damping(b2Body* self, f32 damping);
EXPORT f32 Body_get_angular_damping(const b2Body* self);
EXPORT void Body_set_angular_damping(b2Body* self, f32 damping);
EXPORT f32 Body_get_gravity_scale(const b2Body* self);
EXPORT void Body_set_gravity_scale(b2Body* self, f32 scale);
EXPORT void Body_set_type(b2Body* self, i32 type);
EXPORT i32 Body_get_type(const b2Body* self);
...
EXPORT const b2Fixture* Body_get_fixture_list_const(const b2Body* self);
EXPORT b2JointEdge* Body_get_joint_list(b2Body* self);
EXPORT const b2JointEdge* Body_get_joint_list_const(const b2Body* self);
EXPORT b2ContactEdge* Body_get_contact_list(b2Body* self);
EXPORT const b2ContactEdge* Body_get_contact_list_const(const b2Body* self);
EXPORT b2Body* Body_get_next(b2Body* self);
EXPORT const b2Body* Body_get_next_const(const b2Body* self);
...
EXPORT const b2World* Body_get_world_const(const b2Body* self);
