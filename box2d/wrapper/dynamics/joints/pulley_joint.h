...
EXPORT f32 PulleyJoint_get_length_a(const b2PulleyJoint* self);
EXPORT f32 PulleyJoint_get_length_b(const b2PulleyJoint* self);
EXPORT f32 PulleyJoint_get_ratio(const b2PulleyJoint* self);
EXPORT f32 PulleyJoint_get_current_length_a(const b2PulleyJoint* self);
EXPORT f32 PulleyJoint_get_current_length_b(const b2PulleyJoint* self);