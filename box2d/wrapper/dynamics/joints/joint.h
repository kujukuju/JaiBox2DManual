EXPORT i32 Joint_get_type(const b2Joint* self);
...
EXPORT b2Vec2 Joint_get_reaction_force_virtual(const b2Joint* self,
                                        f32 inv_dt);
EXPORT f32 Joint_get_reaction_torque_virtual(const b2Joint* self,
                                      f32 inv_dt);
EXPORT b2Joint* Joint_get_next(b2Joint* self);
EXPORT const b2Joint* Joint_get_next_const(const b2Joint* self);
