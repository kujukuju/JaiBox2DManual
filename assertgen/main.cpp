...
int main() {
    ...
    assertFile << "    assert(size_of(DrawParticlesCB) == " << sizeof(DrawParticlesCB) << ", \"DrawParticlesCB must be of size " << sizeof(DrawParticlesCB) << ".\");\n";
    ...
    assertFile << "    assert(size_of(b2ParticleSystem) == " << sizeof(b2ParticleSystem) << ", \"b2ParticleSystem must be of size " << sizeof(b2ParticleSystem) << ".\");\n";
    ...
    assertFile << "    assert(size_of(SayGoodbyeParticleGroupCB) == " << sizeof(SayGoodbyeParticleGroupCB) << ", \"SayGoodbyeParticleGroupCB must be of size " << sizeof(SayGoodbyeParticleGroupCB) << ".\");\n";
    ...
    assertFile << "    assert(size_of(ShouldCollideFixtureParticleCB) == " << sizeof(ShouldCollideFixtureParticleCB) << ", \"ShouldCollideFixtureParticleCB must be of size " << sizeof(ShouldCollideFixtureParticleCB) << ".\");\n";
    assertFile << "    assert(size_of(ShouldCollideParticleParticleCB) == " << sizeof(ShouldCollideParticleParticleCB) << ", \"ShouldCollideParticleParticleCB must be of size " << sizeof(ShouldCollideParticleParticleCB) << ".\");\n";
    ...
    assertFile << "    assert(size_of(BeginContactParticleBodyCB) == " << sizeof(BeginContactParticleBodyCB) << ", \"BeginContactParticleBodyCB must be of size " << sizeof(BeginContactParticleBodyCB) << ".\");\n";
    assertFile << "    assert(size_of(EndContactFixtureParticleCB) == " << sizeof(EndContactFixtureParticleCB) << ", \"EndContactFixtureParticleCB must be of size " << sizeof(EndContactFixtureParticleCB) << ".\");\n";
    assertFile << "    assert(size_of(BeginContactParticleCB) == " << sizeof(BeginContactParticleCB) << ", \"BeginContactParticleCB must be of size " << sizeof(BeginContactParticleCB) << ".\");\n";
    assertFile << "    assert(size_of(EndContactParticleCB) == " << sizeof(EndContactParticleCB) << ", \"EndContactParticleCB must be of size " << sizeof(EndContactParticleCB) << ".\");\n";
    ...
    assertFile << "    assert(size_of(ReportFixtureCB) == " << sizeof(ReportFixtureCB) << ", \"ReportFixtureCB must be of size " << sizeof(ReportFixtureCB) << ".\");\n";
    assertFile << "    assert(size_of(ReportParticleCB) == " << sizeof(ReportParticleCB) << ", \"ReportParticleCB must be of size " << sizeof(ReportParticleCB) << ".\");\n";
    assertFile << "    assert(size_of(ShouldQueryParticleSystemCB) == " << sizeof(ShouldQueryParticleSystemCB) << ", \"ShouldQueryParticleSystemCB must be of size " << sizeof(ShouldQueryParticleSystemCB) << ".\");\n";
    ...
    assertFile << "    assert(size_of(ReportParticleRayCastCB) == " << sizeof(ReportParticleRayCastCB) << ", \"ReportParticleRayCastCB must be of size " << sizeof(ReportParticleRayCastCB) << ".\");\n";
    assertFile << "    assert(size_of(ShouldQueryParticleSystemRayCastCB) == " << sizeof(ShouldQueryParticleSystemRayCastCB) << ", \"ShouldQueryParticleSystemRayCastCB must be of size " << sizeof(ShouldQueryParticleSystemRayCastCB) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleDef) == " << sizeof(b2ParticleDef) << ", \"b2ParticleDef must be of size " << sizeof(b2ParticleDef) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleGroupDef) == " << sizeof(b2ParticleGroupDef) << ", \"b2ParticleGroupDef must be of size " << sizeof(b2ParticleGroupDef) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleGroup) == " << sizeof(b2ParticleGroup) << ", \"b2ParticleGroup must be of size " << sizeof(b2ParticleGroup) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleContact) == " << sizeof(b2ParticleContact) << ", \"b2ParticleContact must be of size " << sizeof(b2ParticleContact) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleHandle) == " << sizeof(b2ParticleHandle) << ", \"b2ParticleHandle must be of size " << sizeof(b2ParticleHandle) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleColor) == " << sizeof(b2ParticleColor) << ", \"b2ParticleColor must be of size " << sizeof(b2ParticleColor) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleBodyContact) == " << sizeof(b2ParticleBodyContact) << ", \"b2ParticleBodyContact must be of size " << sizeof(b2ParticleBodyContact) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticlePair) == " << sizeof(b2ParticlePair) << ", \"b2ParticlePair must be of size " << sizeof(b2ParticlePair) << ".\");\n";
    assertFile << "    assert(size_of(b2ParticleTriad) == " << sizeof(b2ParticleTriad) << ", \"b2ParticleTriad must be of size " << sizeof(b2ParticleTriad) << ".\");\n";
    ...
    assertFile << "    assert(size_of(b2IntrusiveListNode) == " << sizeof(b2IntrusiveListNode) << ", \"b2IntrusiveListNode must be of size " << sizeof(b2IntrusiveListNode) << ".\");\n";
    assertFile << "    assert(size_of(b2FreeList) == " << sizeof(b2FreeList) << ", \"b2FreeList must be of size " << sizeof(b2FreeList) << ".\");\n";
    assertFile << "    assert(size_of(b2TrackedBlockAllocator) == " << sizeof(b2TrackedBlockAllocator) << ", \"b2TrackedBlockAllocator must be of size " << sizeof(b2TrackedBlockAllocator) << ".\");\n";
    assertFile << "}\n\n#scope_file\n\n#import \"Basic\";\n";
    assertFile.close();
    return 0;
}
